...
const RecruitmentDashboard = (props: IProps) => {
  const router = useRouter();
  const [dataTable, setDataTable] = useState<IRecruitment[]>(props.recruitments);
  const [filteredData, setFilteredData] = useState<IRecruitment[]>(props.recruitments);
