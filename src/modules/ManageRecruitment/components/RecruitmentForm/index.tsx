...
// import { SearchCaree, ViewAllFields, recruitmentsAPI } from '../../shared/api';
// import {
//   MASTER_DATA_DEGREE,
...
//   useEffect(() => {
//     getAllFields();
//     // Promise.all([recruitmentsAPI.getAllTags()]).then(([tags]) => {
//     //   setTAGS(
...
//     }
//   }, []);
//   const getDistrictsData = useCallback(async (province_code: string) => {
...
//     }
//   };
//   const hanldChangeField = async (
//     idFields: number,
//     option?: { key: string; value: number; children: string }
//   ) => {
//     form.resetFields([RECRUITMENT_DATA_FIELD.career_field_id]);
//     getCaree(idFields);
//   };
...
//   function hanldChangeCaree(
//     value: any,
//     option: { key: string; value: number; children: string }
//   ) {
//     form.resetFields([RECRUITMENT_DATA_FIELD.career_id]);
//   }
